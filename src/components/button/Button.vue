...
const variantList = {
    ...
    information: {
        ...
        outline: "tw-bg-background hover:tw-bg-information/90 tw-border tw-border-solid tw-border-information tw-text-information hover:tw-text-white",
    },
    success: {
        base: "tw-bg-success hover:tw-bg-success/90",
        outline: "tw-bg-background hover:tw-bg-success/90 tw-border tw-border-solid tw-border-success tw-text-success hover:tw-text-white",
    }
}
